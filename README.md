...
```javascript
import { ABS_MASK, CBRT_EPS, EPS, EXPONENT_BIAS, EXPONENT_MASK, MAX, MAX_SAFE_INTEGER, MIN_SAFE_INTEGER, NAN, NINF, NUM_BYTES, PINF, PRECISION, SIGNIFICAND_MASK, SIGN_MASK, SMALLEST_NORMAL, SMALLEST_SUBNORMAL, SQRT_EPS } from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32@v0.3.0-esm/index.mjs';
```
