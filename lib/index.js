...
*/
setReadOnly( constants, 'APERY', require( '@stdlib/constants-float32-apery' ) );
...
*/
setReadOnly( constants, 'CATALAN', require( '@stdlib/constants-float32-catalan' ) );
...
*/
setReadOnly( constants, 'EULERGAMMA', require( '@stdlib/constants-float32-eulergamma' ) );
...
*/
setReadOnly( constants, 'FOURTH_ROOT_EPS', require( '@stdlib/constants-float32-fourth-root-eps' ) );
...
*/
setReadOnly( constants, 'GAMMA_LANCZOS_G', require( '@stdlib/constants-float32-gamma-lanczos-g' ) );
...
*/
setReadOnly( constants, 'LN_SQRT_TWO_PI', require( '@stdlib/constants-float32-ln-sqrt-two-pi' ) );
...
*/
setReadOnly( constants, 'LN_TWO_PI', require( '@stdlib/constants-float32-ln-two-pi' ) );
...
*/
setReadOnly( constants, 'LOG2E', require( '@stdlib/constants-float32-log2-e' ) );
...
*/
setReadOnly( constants, 'LOG10E', require( '@stdlib/constants-float32-log10-e' ) );
...
*/
setReadOnly( constants, 'MAX_LN', require( '@stdlib/constants-float32-max-ln' ) );
...
*/
setReadOnly( constants, 'MAX_NTH_DOUBLE_FACTORIAL', require( '@stdlib/constants-float32-max-nth-double-factorial' ) );
...
*/
setReadOnly( constants, 'MAX_NTH_FACTORIAL', require( '@stdlib/constants-float32-max-nth-factorial' ) );
...
*/
setReadOnly( constants, 'MAX_SAFE_LUCAS', require( '@stdlib/constants-float32-max-safe-lucas' ) );
...
*/
setReadOnly( constants, 'MAX_SAFE_NTH_DOUBLE_FACTORIAL', require( '@stdlib/constants-float32-max-safe-nth-double-factorial' ) );
...
*/
setReadOnly( constants, 'MAX_SAFE_NTH_TRIBONACCI', require( '@stdlib/constants-float32-max-safe-nth-tribonacci' ) );
...
*/
setReadOnly( constants, 'MIN_LN', require( '@stdlib/constants-float32-min-ln' ) );
...
*/
setReadOnly( constants, 'NUM_SIGNIFICAND_BITS', require( '@stdlib/constants-float32-num-significand-bits' ) );
...
*/
setReadOnly( constants, 'PI_SQUARED', require( '@stdlib/constants-float32-pi-squared' ) );
