...
import APERY = require( '@stdlib/constants-float32-apery' );
import CATALAN = require( '@stdlib/constants-float32-catalan' );
...
import EULERGAMMA = require( '@stdlib/constants-float32-eulergamma' );
...
import FOURTH_ROOT_EPS = require( '@stdlib/constants-float32-fourth-root-eps' );
import GAMMA_LANCZOS_G = require( '@stdlib/constants-float32-gamma-lanczos-g' );
...
import LN_SQRT_TWO_PI = require( '@stdlib/constants-float32-ln-sqrt-two-pi' );
import LN_TEN = require( '@stdlib/constants-float32-ln-ten' );
import LN_TWO = require( '@stdlib/constants-float32-ln-two' );
import LN_TWO_PI = require( '@stdlib/constants-float32-ln-two-pi' );
import LOG2E = require( '@stdlib/constants-float32-log2-e' );
import LOG10E = require( '@stdlib/constants-float32-log10-e' );
...
import MAX_LN = require( '@stdlib/constants-float32-max-ln' );
import MAX_NTH_DOUBLE_FACTORIAL = require( '@stdlib/constants-float32-max-nth-double-factorial' );
import MAX_NTH_FACTORIAL = require( '@stdlib/constants-float32-max-nth-factorial' );
...
import MAX_SAFE_LUCAS = require( '@stdlib/constants-float32-max-safe-lucas' );
import MAX_SAFE_NTH_DOUBLE_FACTORIAL = require( '@stdlib/constants-float32-max-safe-nth-double-factorial' );
...
import MAX_SAFE_NTH_TRIBONACCI = require( '@stdlib/constants-float32-max-safe-nth-tribonacci' );
...
import MIN_LN = require( '@stdlib/constants-float32-min-ln' );
...
import NUM_SIGNIFICAND_BITS = require( '@stdlib/constants-float32-num-significand-bits' );
import PHI = require( '@stdlib/constants-float32-phi' );
import PI = require( '@stdlib/constants-float32-pi' );
import PI_SQUARED = require( '@stdlib/constants-float32-pi-squared' );
...
interface Namespace {
	...
	*
	* @example
	* var max = ns.MAX_NTH_DOUBLE_FACTORIAL;
	* // returns 56
	*/
	MAX_NTH_DOUBLE_FACTORIAL: typeof MAX_NTH_DOUBLE_FACTORIAL;

	/**
	* Maximum nth factorial when stored in single-precision floating-point format.
	*
	* @example
	* var max = ns.MAX_NTH_FACTORIAL;
	* // returns 34
	*/
	MAX_NTH_FACTORIAL: typeof MAX_NTH_FACTORIAL;
	...
	*
	* @example
	* var max = ns.MAX_SAFE_NTH_DOUBLE_FACTORIAL;
	* // returns 16
	*/
	MAX_SAFE_NTH_DOUBLE_FACTORIAL: typeof MAX_SAFE_NTH_DOUBLE_FACTORIAL;
	...
	*
	* @example
	* var max = ns.MAX_SAFE_NTH_TRIBONACCI;
	* // returns 30
	*/
	MAX_SAFE_NTH_TRIBONACCI: typeof MAX_SAFE_NTH_TRIBONACCI;
	...
	*
	* @example
	* var bits = ns.NUM_SIGNIFICAND_BITS;
	* // returns 23
	*/
	NUM_SIGNIFICAND_BITS: typeof NUM_SIGNIFICAND_BITS;
